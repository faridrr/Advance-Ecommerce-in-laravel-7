...
class OrderController extends Controller
{
    ...
    public function incomeChart(Request $request)
    {
        ...
        foreach ($items as $month => $item_collections) {
            ...
            foreach ($item_collections as $item) {
                ...
                $quantity = $item->cart_info->sum('quantity');
                // dd($amount);
                $m = intval($month);
                // return $m;
                isset($result[$m]) ? $result[$m] += $quantity : $result[$m] = $quantity;
            }
    ...
    public function incomeChart3(Request $request)
    {
        $year = \Carbon\Carbon::now()->year;
        // dd($year);
        $items = Order::with(['cart_info'])->whereYear('updated_at', $year)->where('status', 'Terminer')->get()
            ->groupBy(function ($d) {
                return \Carbon\Carbon::parse($d->created_at)->format('m');
            });
        // dd($items);
     ...
     * Total
     */
    public function incomeChartMonth($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
    ...
    public function incomeChartMonth1($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonth2($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonth3($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
        // dd($year);
        $items = Order::with(['cart_info'])->whereMonth('updated_at', $month)->where('status', 'Terminer')->get()
            ->groupBy(function ($d) {
                return \Carbon\Carbon::parse($d->updated_at)->format('d');
            });
        $result = [];
    ...
    public function incomeChartMonthStandard($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
        ...
        foreach ($items as $day => $item_collections) {
            foreach ($item_collections as $item) {
                $quantity = 0;
                foreach ($item->cart_info as $info) {
    ...
    public function incomeChartMonthStandard1($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthStandard2($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthStandard3($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
     ...
     * Logo
     */
    public function incomeChartMonthLogo($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthLogo1($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthLogo2($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthLogo3($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthPersonalized($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthPersonalized1($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthPersonalized2($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
    ...
    public function incomeChartMonthPersonalized3($month)
    {
        $year = \Carbon\Carbon::now()->year;
        $dt = "$year-$month-01";
        $last_day = date("t", strtotime($dt));
