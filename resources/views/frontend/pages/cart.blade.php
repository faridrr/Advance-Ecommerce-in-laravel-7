                                ...
                                @foreach(Helper::getAllProductFromCart() as $key=>$cart)
                                    <tr>
                                        ...
                                        <td class="image" data-title="No">
                                            ...
                                            @if(!is_null($cart->variation))

                                                <br><br>
                                                @if($cart->variation == 'var_blue')
                                                    <strong>Couleur</strong> : Blue
                                                @elseif($cart->variation == 'var_red')
                                                    <strong>Couleur</strong> : Rouge
                                                @elseif($cart->variation == 'var_pink')
                                                    <strong>Couleur</strong> : Rose
                                                @elseif($cart->variation == 'var_white')
                                                    <strong>Couleur</strong> : Blanc
                                                @elseif($cart->variation == 'var_orange')
                                                    <strong>Couleur</strong> : Orange
                                                @elseif($cart->variation == 'var_green')
                                                    <strong>Couleur</strong> : Vert
                                                @elseif($cart->variation == 'var_yellow')
                                            ...
                                            @if(!is_null($cart->taille))
                                                <br><br>
                                                <strong>Taille</strong> : {{ $cart->taille }}
                                            @endif
                                        </td>
                                        ...
                                        <td class="price" data-title="Price"><span>{{number_format($cart['price'],2)}} DZA</span>
                                        </td>
                                        ...
                                        <td class="total-amount cart_single_price" data-title="Total"><span
                                                class="money">{{$cart['amount']}} DZA</span></td>
                            ...
                            @else
                                <tr>
                                    <td class="text-center">
                                        Panier non disponibles.<a href="{{route('product-grids')}}" style="color:blue;">Continuer
                                            vos achats</a>
                        ...
                        <div class="row">
                                ...
                                <div class="left">
                                    <div class="coupon">
                                        <form action="{{route('coupon-store')}}" method="POST">
                                            @csrf
                                            <input name="code" placeholder="Saisissez votre coupon">
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        @if(session()->has('coupon'))
                                            <li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">
                                                Vous Gagnez<span>{{number_format(Session::get('coupon')['value'],2)}} DZA</span>
                                            </li>
                                        @endif
                                        @php
                                        ...
                                        @endphp
                                        @if(session()->has('coupon'))
                                            <li class="last" id="order_total_price">Vous Payé<span>{{number_format($total_amount,2)}} DZA</span>
                                            </li>
                                        @else
                                            <li class="last" id="order_total_price">Vous Payé<span>{{number_format($total_amount,2)}} DZA</span>
                                            </li>
                                    ...
                                    <div class="button5">
                                        <a href="{{route('checkout')}}" class="btn">Paiement</a>
