...
@section('title','Michket || ' . $post->title)
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Par {{$post->author_info['name']}}</a><a
                                                href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('d-m-Y')}}</a><a
                                                href="javascript:void(0);"><i class="fa fa-comments"></i>Commenter ({{$post->allComments->count()}})</a></span>
                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group button">
                                                            <button type="submit" class="btn"><span
                                                                    class="comment_btn comment">Poster un commentaire</span><span
                                                                    class="comment_btn reply" style="display: none;">Répondre</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            @else
                                <p class="text-center p-5">
                                    You need to <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Connexion</a>
                                    OR <a style="color:blue" href="{{route('register.form')}}">S'inscrire</a> pour un
                                    commentaire.
