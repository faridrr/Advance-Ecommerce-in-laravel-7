                                                            ...
                                                            <ul>
                                                                @foreach($cat_info->child_cat as $sub_menu)
                                                                    <li>
                                                                        ...
                                                                        @endif
                                                                        @php
                                                                            $childs =   App\Models\Category::where('parent_id',$sub_menu->id)->orderBy('id','ASC')->get();
                                                                        @endphp
                                                                        @if($childs->count() > 0)
                                                                            <ul>
                                                                                @foreach($childs as $child)
                                                                                    <li>
                                                                                        @if(!isset($subcat3))
                                                                                        <a href="{{route('product-sub-cat1',[$cat_info->slug,$sub_menu->slug,$child->slug])}}">{{$child->title}}</a>
                                                                                        @endif
                                                                                        @php
                                                                                            $childs2 =   App\Models\Category::where('parent_id',$child->id)->orderBy('id','ASC')->get();
                                                                                        @endphp
                                                                                        @if($childs2->count() > 0)
                                                                                            <ul>
                                                                                                @foreach($childs2 as $child2)
                                                                                                    <li>
                                                                                                        <a href="{{route('product-sub-cat2',[$cat_info->slug,$sub_menu->slug,$child->slug,$child2->slug])}}">{{$child2->title}}</a>
                                                                                                    </li>
                                                                                                @endforeach
                                                                                            </ul>
                                                                                        @endif
...
{{--                                                                            @foreach($childs as $child)--}}
{{--                                                                                <li>--}}
{{--                                                                                    <a href="{{route('product-sub-cat',[$cat_info->slug,$sub_menu->slug,$child->slug])}}">{{$child->title}}</a>--}}
...
{{--                                                                                            @foreach($childs2 as $child2)--}}
{{--                                                                                                <li>--}}
{{--                                                                                                    <a href="{{route('product-sub-cat',[$cat_info->slug,$sub_menu->slug,$child->slug,$child2->slug])}}">{{$child2->title}}</a>--}}
{{--                                                                                                </li>--}}
{{--                                                                                            @endforeach--}}
{{--                                                                                        </ul>--}}
{{--                                                                                    @endif--}}
